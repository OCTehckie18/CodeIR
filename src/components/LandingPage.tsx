...
function Particles() {
  const particles = Array.from({ length: 30 }, (_, i) => ({
    ...
    color: ["#22d3ee", "#3b82f6", "#818cf8", "#34d399", "#f87171", "#a78bfa"][
  ...
  const lines = [
    {
      tokens: [
        { t: "def ", c: "#818cf8" },
        { t: "evaluate_code", c: "#22d3ee" },
        { t: "(solution, testcases):", c: "#e2e8f0" },
      ],
    },
    {
      tokens: [
    ...
    },
    {
      tokens: [
        { t: "        output = ", c: "#e2e8f0" },
        { t: "run", c: "#22d3ee" },
        { t: "(solution, tc)", c: "#e2e8f0" },
      ],
    },
    {
      tokens: [
        { t: "        score = ai_engine", c: "#e2e8f0" },
        { t: ".score(output)", c: "#22d3ee" },
      ],
    },
    {
      tokens: [
        { t: "        results", c: "#e2e8f0" },
        { t: ".append(score)", c: "#34d399" },
      ],
    },
    {
      tokens: [
    ...
    {
      tokens: [
        { t: "# ✓ Correctness: ", c: "#94a3b8" },
        { t: "9.2/10", c: "#34d399" },
      ],
    },
    {
      tokens: [
        { t: "# ⚡ Efficiency:  ", c: "#94a3b8" },
        { t: "8.7/10", c: "#f59e0b" },
      ],
    },
    {
    ...
    <div className="relative w-full rounded-2xl overflow-hidden border border-white/10 bg-[#0d1117] shadow-[0_0_80px_rgba(6,182,212,0.15)]">
      ...
      <div className="flex items-center gap-2 px-4 py-3 bg-white/[0.03] border-b border-white/5">
        ...
        <span className="ml-3 text-xs text-slate-500 font-mono">
          solution.py — CodeIR Workspace
        </span>
        <div className="ml-auto flex items-center gap-2">
          <span className="text-[10px] text-emerald-400 font-semibold bg-emerald-400/10 border border-emerald-400/20 px-2 py-0.5 rounded">
            ● Live
          </span>
        </div>
      </div>
      ...
      <div className="p-4 font-mono text-sm space-y-1.5 overflow-hidden">
        {lines.map((line, li) => (
          <div key={li} className="flex gap-4">
            <span className="text-slate-700 text-xs w-4 shrink-0 select-none">
              {li + 1}
            </span>
            <div>
      ...
      <div className="m-3 mt-0 p-3 rounded-xl bg-cyan-500/5 border border-cyan-500/20">
        ...
        <p className="text-[11px] text-slate-400 leading-relaxed">
          Efficient O(n) solution detected. Consider using a generator for
          memory optimization. Edge case for empty input handled correctly.
        </p>
      </div>
    </div>
  );
...
export default function LandingPage({ onGetStarted }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#050510] text-white font-sans overflow-x-hidden">
      {/* ═══════ FIXED NAVBAR ═══════ */}
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-[#050510]/90 backdrop-blur-xl border-b border-white/5 shadow-[0_1px_30px_rgba(0,0,0,0.5)]" : "bg-transparent"}`}
      >
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img
              src={logo}
              alt="CodeIR"
              className="h-8 w-auto drop-shadow-[0_0_10px_rgba(6,182,212,0.7)]"
            />
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="hidden md:block text-sm text-slate-400 hover:text-white transition-colors font-medium px-4 py-2"
            >
              Sign In
            </button>
            <button
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-16 items-center w-full">
          ...
          <div>
            ...
            <h1
              className="text-5xl xl:text-7xl font-black tracking-tight leading-[1.05] mb-6 animate-fade-in-up"
            ...
            {/* Typewriter */}
            <div
              className="flex items-center gap-3 mb-8 h-8 animate-fade-in-up"
            ...
            <p
              className="text-slate-500 text-lg leading-relaxed mb-10 max-w-xl animate-fade-in-up"
              style={{ animationDelay: "0.3s" }}
            >
              A unified platform where students write, submit, and receive
              AI-grade feedback on their code — and instructors evaluate, track,
            ...
            {/* Trust line */}
            <div
              className="flex items-center gap-4 mt-10 animate-fade-in-up"
              style={{ animationDelay: "0.5s" }}
            >
              <div className="flex -space-x-1.5">
                {["#22d3ee", "#3b82f6", "#818cf8", "#34d399", "#f87171"].map(
                  (c, i) => (
                    <div
                      key={i}
                      className="w-7 h-7 rounded-full border border-[#050510] flex items-center justify-center text-xs font-bold"
                      style={{
                        background: c + "33",
                        color: c,
                        borderColor: "#050510",
      ...
      <section
        ref={statsRef}
        className="relative py-12 border-y border-white/5 bg-white/[0.01] backdrop-blur-sm overflow-hidden"
      >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="flex flex-col items-center text-center">
                ...
                <div className={`text-4xl font-black ${color} tabular-nums`}>
                  {value}
                  {suffix}
                </div>
      ...
      <section id="features" className="py-28 max-w-7xl mx-auto px-6">
        <div
          ref={feat1.ref}
          className={`text-center mb-20 transition-all duration-700 ${feat1.visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          ...
          <h2 className="text-4xl xl:text-5xl font-black tracking-tight mb-5">
            ...
            <span className="gradient-text-cyan-blue">
              teach, and learn code
            </span>
          </h2>
          <p className="text-slate-500 text-lg max-w-2xl mx-auto leading-relaxed">
            From the student's first keystroke to the instructor's final grade —
            CodeIR handles the entire evaluation lifecycle with AI precision.
          </p>
        </div>
        ...
        >
          {features.map(
            (
              { icon: Icon, title, desc, gradient, border, glow, accent, bg },
              i,
            ) => (
              <div
                key={i}
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.boxShadow = `0 0 40px 0 ${glow}`)
                }
                onMouseLeave={(e) =>
              ...
              >
                <div
                  className="absolute -top-12 -right-12 w-24 h-24 rounded-full blur-[40px] opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                  style={{ background: glow }}
                />
                <div
                  className={`w-12 h-12 ${bg} border ${border} rounded-2xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300`}
                >
                  <Icon size={22} className={accent} />
                </div>
                <h3
                  className={`text-lg font-bold text-white mb-2 group-hover:${accent} transition-colors`}
                >
                  {title}
                </h3>
      ...
      <section
        id="ai-models"
        className="py-28 bg-white/[0.01] border-y border-white/5"
      >
        <div className="max-w-7xl mx-auto px-6">
          <div
            ref={aiSection.ref}
            className={`text-center mb-20 transition-all duration-700 ${aiSection.visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/[0.02] text-slate-400 text-xs font-bold uppercase tracking-widest mb-6">
            ...
            <p className="text-slate-500 text-lg max-w-2xl mx-auto">
              Choose between edge-local privacy with Ollama, cloud-scale power
              with Gemini, or ultra-fast open-source models via Groq — switch
              with a single click.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {/* Ollama Card */}
            <div
              className={`relative rounded-3xl border border-indigo-500/20 bg-gradient-to-br from-indigo-500/10 to-purple-500/5 p-8 overflow-hidden transition-all duration-700 ${aiSection.visible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10"}`}
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-indigo-400 text-sm font-semibold">
                      Local Edge AI · Privacy First
                    </p>
                  </div>
                  <span className="ml-auto px-3 py-1 rounded-full text-xs font-bold border border-indigo-500/30 bg-indigo-500/10 text-indigo-400">
                    CPU/Local
                  </span>
                </div>
                <div className="space-y-3 mb-6">
                  {[
                    ...
                    "No API key required",
                    "Works fully offline",
                    "Low latency on local hardware",
                    "Supports llama3, codellama models",
                  ].map((f, i) => (
                    <div
                      key={i}
                ...
                <div className="bg-[#0d1117] rounded-xl p-4 border border-white/5 font-mono text-xs">
                  ...
                  <div className="text-slate-500 space-y-1">
                    <div>
                      → Loading model:{" "}
                      <span className="text-indigo-300">codellama:13b</span>
                    </div>
                    <div>→ Running evaluation pipeline...</div>
                    <div className="text-emerald-400">
                      ✓ Evaluation complete in 1.8s
                    </div>
                  </div>
            ...
            {/* Gemini Card */}
            <div
              className={`relative rounded-3xl border border-blue-500/20 bg-gradient-to-br from-blue-500/10 to-cyan-500/5 p-8 overflow-hidden transition-all duration-700 ${aiSection.visible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10"}`}
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <span className="ml-auto px-3 py-1 rounded-full text-xs font-bold border border-blue-500/30 bg-blue-500/10 text-blue-400">
                    Cloud
                  </span>
                </div>
                <div className="space-y-3 mb-6">
                ...
                <div className="bg-[#0d1117] rounded-xl p-4 border border-white/5 font-mono text-xs">
                  <div className="text-blue-400 mb-2">
                    {">"} Requesting Gemini evaluation...
                  </div>
                  <div className="text-slate-500 space-y-1">
                    <div>
                      → Model:{" "}
                      <span className="text-blue-300">gemini-2.0-flash</span>
                    </div>
            ...
            {/* Groq Card */}
            <div
              className={`relative rounded-3xl border border-amber-500/20 bg-gradient-to-br from-amber-500/10 to-orange-500/5 p-8 overflow-hidden transition-all duration-700 ${aiSection.visible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10"}`}
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-amber-400 text-sm font-semibold">
                      Cloud AI · Lightning Fast LPU
                    </p>
                  </div>
                  <span className="ml-auto px-3 py-1 rounded-full text-xs font-bold border border-amber-500/30 bg-amber-500/10 text-amber-400">
                    Cloud
                  </span>
                </div>
                <div className="space-y-3 mb-6">
                  {[
                    ...
                    "Free-tier ultra-fast LPU inference",
                ...
                <div className="bg-[#0d1117] rounded-xl p-4 border border-white/5 font-mono text-xs">
                  ...
                  <div className="text-slate-500 space-y-1">
                    ...
                    <div className="text-emerald-400">
                      ✓ Done in 0.12s. Feedback generated.
                    </div>
                  </div>
                  <div className="flex gap-1 mt-3">
                    {[0, 1, 2].map((d) => (
      ...
      <section id="dashboards" className="py-28 max-w-7xl mx-auto px-6">
        <div
          ref={dashSection.ref}
          className={`text-center mb-20 transition-all duration-700 ${dashSection.visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/[0.02] text-slate-400 text-xs font-bold uppercase tracking-widest mb-6">
            <Users size={12} className="text-emerald-400" /> Role-Based
            Dashboards
          </div>
          <h2 className="text-4xl xl:text-5xl font-black tracking-tight mb-5">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div
            className={`transition-all duration-700 ${dashSection.visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
            <div className="relative rounded-3xl border border-cyan-500/20 bg-gradient-to-br from-cyan-500/5 to-blue-500/3 overflow-hidden">
              <div className="px-6 py-4 border-b border-white/5 flex items-center gap-3">
                ...
                <span className="ml-auto text-[10px] border border-cyan-500/30 text-cyan-400 px-2 py-0.5 rounded bg-cyan-500/10 font-bold">
                  STUDENT
                </span>
              </div>
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-center gap-4 p-4 bg-white/[0.02] rounded-2xl border border-white/5">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-400 to-blue-600 flex items-center justify-center font-black text-lg">
                    S
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ["🔥 Streak", "7 days", "orange"],
                    ["🏆 Best", "15 days", "yellow"],
                    ["⚡ Avg Score", s ? `${s.avgScore}/30` : "—/30", "cyan"],
                  ].map(([label, val, c], i) => (
                    <div
                      key={i}
                    ...
                    >
                      ...
                      <div className={`text-sm font-black text-${c}-400`}>
                        {val}
                      </div>
                    </div>
                  ))}
                ...
                <div className="bg-white/[0.02] border border-white/5 rounded-xl p-4 space-y-3">
                  {[
                    [
                      "Correctness",
                      "emerald",
                      s ? Math.round(s.avgCorrectness * 10) : 80,
                    ],
                    [
                      "Efficiency",
                      "yellow",
                      s ? Math.round(s.avgEfficiency * 10) : 70,
                    ],
                    [
                      "Code Style",
                      "rose",
                      s ? Math.round(s.avgStyle * 10) : 85,
                    ],
                  ].map(([lbl, c, v]) => (
            ...
            <div className="mt-4 text-center">
              <p className="text-slate-500 text-sm">
                LeetCode-style student profile with AI-driven performance
                insights
              </p>
            </div>
          </div>
          ...
          >
            <div className="relative rounded-3xl border border-red-500/20 bg-gradient-to-br from-red-500/5 to-rose-500/3 overflow-hidden">
              <div className="px-6 py-4 border-b border-white/5 flex items-center gap-3">
                ...
                <span className="ml-auto text-[10px] border border-red-500/30 text-red-400 px-2 py-0.5 rounded bg-red-500/10 font-bold">
                  INSTRUCTOR
                </span>
              </div>
              <div className="p-6 space-y-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    [
                      "Pending",
                      s ? String(s.totalSubmissions - s.totalEvaluations) : "—",
                      "orange",
                    ],
                    [
                      "Evaluated",
                      s ? String(s.totalEvaluations) : "—",
                      "emerald",
                    ],
                    ["Total", s ? String(s.totalSubmissions) : "—", "blue"],
                  ].map(([lbl, val, c]) => (
                    <div
                      key={lbl as string}
                      className={`bg-white/[0.02] border border-${c}-500/20 rounded-xl p-4`}
                    >
                      <div
                        className={`text-3xl font-black text-${c}-400 tabular-nums`}
                      >
                        {val}
                      </div>
                ...
                <div className="bg-white/[0.02] border border-white/5 rounded-xl overflow-hidden">
                  <div className="px-4 py-2.5 border-b border-white/5 text-[10px] text-slate-500 uppercase tracking-wider font-semibold flex gap-4">
                    ...
                    <span className="flex-1 hidden sm:block">Problem</span>
                    <span>Status</span>
                  ...
                  {[
                    ...
                    <div
                      key={i}
                      className="px-4 py-3 flex items-center gap-4 border-b border-white/[0.03] hover:bg-white/[0.02] transition-colors"
                    >
                      <div className="flex-1 text-xs font-semibold text-slate-300">
                        {name}
                      </div>
                      ...
                      <span
                        className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase ${status === "evaluated" ? "bg-emerald-500/10 text-emerald-400 border border-emerald-500/20" : "bg-orange-500/10 text-orange-400 border border-orange-500/20"}`}
                      >
                        {status}
                      </span>
                      <button
                        className={`text-[10px] font-bold px-2 py-1 rounded border transition-colors ml-auto ${action === "Grade" ? "border-red-500/30 text-red-400 hover:bg-red-500/10" : "border-white/10 text-slate-400 hover:bg-white/5"}`}
                      >
                        {action} →
                      </button>
                    </div>
                ...
                <div className="flex items-center gap-3 bg-white/[0.02] border border-white/5 rounded-xl px-4 py-3">
                  ...
                  <span className="text-xs text-slate-600 flex-1">
                    Search student, email, or problem...
                  </span>
                  <div className="flex gap-1.5">
                    <span className="text-[10px] border border-white/10 rounded px-2 py-0.5 text-slate-500">
                      All
                    </span>
                    <span className="text-[10px] border border-orange-500/30 rounded px-2 py-0.5 text-orange-400">
                      Pending
                    </span>
                  </div>
                </div>
            ...
            <div className="mt-4 text-center">
              <p className="text-slate-500 text-sm">
                Real-time submission tracker with search, filter, and one-click
                evaluation
              </p>
            </div>
          </div>
        ...
        <section className="py-28 bg-white/[0.01] border-y border-white/5">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/[0.02] text-slate-400 text-xs font-bold uppercase tracking-widest mb-6">
                <Star size={12} className="text-yellow-400" /> What Our Users
                Say
              </div>
              <h2 className="text-4xl xl:text-5xl font-black tracking-tight mb-5">
                Trusted by students
                ...
                {[
                  ...
                  >
                    <div className="flex items-center gap-3 mb-4">
                      <div
                        className={`w-10 h-10 rounded-xl flex items-center justify-center font-bold text-sm ${t.role === "instructor" ? "bg-gradient-to-br from-red-500/30 to-rose-500/20 text-red-400" : "bg-gradient-to-br from-cyan-500/30 to-blue-500/20 text-cyan-400"}`}
                      >
                      ...
                      <div>
                        ...
                        <div
                          className={`text-[10px] font-bold uppercase tracking-widest ${t.role === "instructor" ? "text-red-400" : "text-cyan-400"}`}
                        >
                          {t.role}
                        </div>
                      </div>
      ...
      <div className="py-10 border-y border-white/5 overflow-hidden bg-white/[0.01]">
        <div
          className="flex gap-12 animate-[slide-in-right_0s] whitespace-nowrap"
        ...
        >
          ...
          >
            {[
              ...
              <span
                key={tech}
                className="text-slate-600 text-sm font-semibold uppercase tracking-widest hover:text-slate-400 transition-colors shrink-0"
              >
                {tech}
              </span>
            ))}
      ...
      <section id="team" className="py-28 max-w-7xl mx-auto px-6">
        <div className="text-center mb-20 animate-fade-in-up">
          ...
          <p className="text-slate-500 text-lg max-w-2xl mx-auto leading-relaxed">
            Built by a passionate team of developers dedicated to transforming
            computer science education through AI.
          </p>
        </div>
          ...
          {[
            {
              ...
              image:
                "https://media.licdn.com/dms/image/v2/D5603AQHkjRFC9-i4Jw/profile-displayphoto-scale_400_400/B56Z2Q7qwuK4Ag-/0/1776253068650?e=1779321600&v=beta&t=5RXdkC0JfYPcJBOsx6KQcVNtqnVp3mP9vFW8QJ7nFsQ", // Placeholder
            },
            {
              ...
              image:
                "https://media.licdn.com/dms/image/v2/D5603AQGkpqSJUvZhrg/profile-displayphoto-scale_400_400/B56Z2QzDUlHkAk-/0/1776250801781?e=1779321600&v=beta&t=rxJvpNF7VFWskzmnY9QWwCjINU_O_hAiZBszCgNUc0s", // Placeholder
            },
            {
              name: "Anushka Singh",
              ...
              image:
                "https://media.licdn.com/dms/image/v2/D5603AQGSuBIDD3qmzg/profile-displayphoto-crop_800_800/B56ZzPia_rIoAI-/0/1773008435723?e=1779321600&v=beta&t=sFQoL82kqMc8PTCa5YDovlWTNiLy_rBDsNRhga5ccyo", // Placeholder
            },
          ].map((dev, i) => (
            <div
              key={dev.name}
            ...
            >
              <div
                className={`absolute -top-20 -right-20 w-48 h-48 rounded-full bg-${dev.color}-500/10 blur-[60px] group-hover:bg-${dev.color}-500/20 transition-colors duration-500`}
              />
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                ...
                <div
                  className={`text-xs font-bold uppercase tracking-widest text-${dev.color}-400 mb-6 bg-${dev.color}-500/10 px-3 py-1 rounded-full border border-${dev.color}-500/20`}
                >
                  {dev.role}
                </div>
                ...
                <div className="w-full space-y-3 mb-8 text-left">
                  {dev.points.map((point, idx) => (
                    ...
                    >
                      <CheckCircle
                        size={14}
                        className={`text-${dev.color}-400 shrink-0 mt-0.5`}
                      />
                ...
                <div className="flex items-center gap-4 mt-auto">
                  <a
                    ...
                    className="w-10 h-10 rounded-full bg-white/[0.03] border border-white/10 flex items-center justify-center text-slate-400 hover:text-white hover:bg-white/10 transition-all hover:scale-110"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full bg-white/[0.03] border border-white/10 flex items-center justify-center text-slate-400 hover:text-blue-400 hover:bg-blue-500/10 hover:border-blue-500/30 transition-all hover:scale-110"
                  >
                    <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current">
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div
          ref={ctaSection.ref}
          className={`relative z-10 max-w-4xl mx-auto px-6 text-center transition-all duration-700 ${ctaSection.visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          ...
          <p className="text-slate-500 text-xl mb-12 max-w-2xl mx-auto leading-relaxed">
            Join CodeIR today and experience AI-powered evaluation that adapts
            to your curriculum, respects your privacy, and scales with your
            class.
          </p>
